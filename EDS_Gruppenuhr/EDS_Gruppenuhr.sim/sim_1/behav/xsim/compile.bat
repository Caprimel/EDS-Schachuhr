...
REM
REM Generated by Vivado on Thu Apr 16 14:56:54 +0200 2026
...
echo "xvhdl --incr --relax -prj Test_Anzeige_vhdl.prj"
call xvhdl  --incr --relax -prj Test_Anzeige_vhdl.prj -log xvhdl.log
